...
O SportLife é uma aplicação web desenvolvida como Trabalho de Conclusão de Curso (TCC) do curso Técnico em Informática para Internet. Seu objetivo é conectar praticantes de esportes por meio[...]
...
Criar uma plataforma que incentive a prática esportiva e facilite a interação entre atletas amadores e entusiastas de diferentes modalidades, permitindo organizar atividades esportivas de forma[...]
